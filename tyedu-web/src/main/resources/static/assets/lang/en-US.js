loadLocaleMessages("en-US", Object.assign({
    "productName": "K12 AI Learning",
    ...
    "确定解除绑定？": "Are you sure to unbind?",
    "该微信账号已被其它用户绑定，是否继续？": "This WeChat account has already been bound by another user. Do you want to continue?",
    "微信绑定成功": "WeChat binding successful",
    "微信绑定已解除": "WeChat binding has been released",
    "已绑定": "Already bound",
    "未绑定": "Unbound",
    "绑定": "Binding",
    "解绑": "Unbind",
    ...
    "登出": "Logout",
    "局域网": "LAN",
    "新增机构": "Create Organization",
    "修改机构": "Modify Organization",
    ...
    validations: {
        ...
        "confirmed": "The {0} field confirmation does not match",
        ...
        "not_one_of": "The {0} field is not a valid value",
        "ext": "The {0} field is not a valid file",
        "image": "The {0} field must be an image",
        "integer": "The {0} field must be an integer",
        "length": "The {0} field must be {1} long",
        ...
        "one_of": "The {0} field is not a valid value",
        "regex": "The {0} field format is invalid",
        "required_if": "The {0} field is required",
        "required": "The {0} field is required",
        "size": "The {0} field size must be less than {1}KB",
